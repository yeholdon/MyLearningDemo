/**
 * play_again03.c : ask if user wants another transaction
 * method : set tty into char-by-char mode, no-echo mode read char, return result
 * return: 0 =>yes, 1=>no
 * better: time out if user walk away
*/
#include <stdio.h>
#include <termio.h>
